...
export default async (request) => {
  ...
  for (const c of courses || []) {
    ...
    const record = { course: c.title, city: c.city, host: c.host_name, to, dates, link };
    ...
    try {
      await sendEmail({ to, first, title: c.title, city: c.city, dates, link });
...
async function sendEmail({ to, first, title, city, dates, link }) {
...
`<div style="font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;font-size:15px;line-height:1.6;color:#16181b;max-width:560px;margin:0 auto">
  ...
  <p>Thanks for hosting us,<br>Nathan<br>BirdBox Coaching</p>
</div>`;
